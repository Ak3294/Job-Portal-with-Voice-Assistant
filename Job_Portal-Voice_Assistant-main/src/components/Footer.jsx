...
const Footer = () => {
    return (
        ...
        <footer class="bg-white dark:bg-dark-900 mt-10">
            <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8 grey-bg">
                <div class="md:flex md:justify-between">
                    <div class="mb-6 md:mb-0">
                        ...
                        <p class="mt-3 ml-10">Acube: A premier middleware platform linking talented individuals to outstanding job
                            <br></br>
                            opportunities,facilitating seamless connections for career growth and organizational 
                            <br></br>
                            success. Join us in shaping your future today!
                        </p>
                    ...
                    <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        ...
                        <div>
                            ...
                            <ul class="text-gray-500 dark:text-gray-400 font-medium">
                                ...
                                <li>
                                    <a href="https://linkedin/in" class="hover:underline">Linkedin</a>
                                </li>
                            </ul>
                        </div>
                        <div>
                ...
                <div class="sm:flex sm:items-center sm:justify-between">
                    <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://flowbite.com/" class="hover:underline">Acube™</a>. All Rights Reserved.
                    </span>
